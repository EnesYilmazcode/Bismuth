...
function TextAreaChat({
  ...
  onFocus,
  isLoading = false,
  placeholder = 'What can Bismuth help you build today?',
  type,
  stopGenerating,
  disabled = false,
  model,
      ...
      >
        ...
        <div className="flex items-center justify-between border-t border-[#2a2a2a] p-3">
          ...
          <div className="flex items-center gap-2">
            {/* Model picker is hidden in the local "Claude is the model"
                fork — message creation still gets a `model` field via the
                hardcoded value passed in from PromptView/ChatSection. */}
